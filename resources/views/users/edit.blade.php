                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-8"> 
                              <select class="form-control"  id="sexuality" name="sexuality">
                                 <option value="" >Select</option>
                                 <option value="heterosexual"@if($userprofile->sexuality == "heterosexual") selected="selected"  @endif  >Heterosexual</option>
...
<fieldset>
    <div class="form-group">
                            <label class="control-label col-lg-4" for="Projectname">Project name:</label>
                            <div class="col-lg-8">
                              <input type="text" class="form-control" id="projectname">
                            </div>
                      </div>
